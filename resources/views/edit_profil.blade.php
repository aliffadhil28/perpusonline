    ...
    <div class="container" style="margin-bottom:2%">
        ...
        <div class="row">
            <div class="col-7" style="margin-left:%; border-radius:20px;filter: box-shadow: 0 3px 20px rgba(0, 0, 0, .5);background: #FFFFFF;margin-top:5%;">
                ...
                <a href="#">
                    <button type="submit" class="btn btn-primary" style="background: linear-gradient(90deg, #35EB73 0%, #65DDC7 100%);filter: drop-shadow(8px 4px 35px rgba(56, 125, 130, 0.44));width: 20%; margin-top:25%;margin-bottom:5%; margin-left:75%;border-radius:30px">
                        Simpan
                    </button>
                </a>
            </div>
