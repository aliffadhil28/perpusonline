...
<head>
    ...
    <title>SMK 5 Kepanjen Perpus</title>
</head>
...
<body>
    <header>
                ...
                <div class="box-navigation">
                    ...
                    <div class="box">
                        <ul>
                            ...
                            <li><a href="/koleksi_buku">Koleksi Buku</a></li>
        ...
        <!-- hero -->
        <section class="hero">
            <h1>SMK 5 Muhamaddiyah Perpustakaan Online</h1>
        </section>
    </header>
    <section class="about">
        <div class="container">
            <div class="box-about">
                <div class="box">
                    ...
                    <p>
                        ...
                        ex iure voluptas, dolor id ipsam, ab labore voluptatem doloremque beatae saepe non quam numquam
                        quod laborum?
                    </p>
                </div>
                <div class="box">
